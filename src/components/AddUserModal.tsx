    ...
    >
      <div className="rounded-2xl max-w-md w-full shadow-2xl border animate-slide-up bg-white border-slate-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {success && (
            <div className="p-3 rounded-xl flex flex-col gap-2 bg-green-50 border border-green-200">
              <div className="flex items-center gap-3">
                <CheckCircle2 className="w-5 h-5 text-green-600 flex-shrink-0" />
                <p className="text-green-700 text-sm">Kullanıcı başarıyla oluşturuldu!</p>
              </div>
              <p className="text-xs ml-8 text-slate-500">
          ...
          <div className="p-3 rounded-xl border bg-blue-50 border-blue-200">
            <p className="text-xs text-blue-700">
              <strong>Not:</strong> Kullanıcı adından otomatik olarak <code className="px-1 py-0.5 rounded bg-blue-100">@ayt.local</code> uzantılı e-posta oluşturulacaktır.
            </p>
          </div>
