  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="px-5 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-slate-800">Saha Notları</h1>
            ...
            <div className="max-w-7xl mx-auto px-4 py-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full rounded-xl pl-12 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-all bg-white border border-slate-200 text-slate-800 placeholder-slate-400"
                />
              </div>
            </div>
          </div>
        ...
        >
          <div className="border-t border-slate-200 bg-slate-50">
            <div className="max-w-7xl mx-auto px-4 py-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Ada No"
                      className="w-full rounded-lg pl-9 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors bg-white border border-slate-200 text-slate-800 placeholder-slate-400"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full rounded-lg pl-9 pr-8 py-2.5 text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors bg-white border border-slate-200 text-slate-800"
                    >
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full rounded-lg pl-3 pr-8 py-2.5 text-sm appearance-none focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors bg-white border border-slate-200 text-slate-800"
                    >
                      <option value="">Tümü</option>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg pl-9 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors bg-white border border-slate-200 text-slate-800"
                    />
                  </div>
                </div>
                  ...
                  .map((field) => (
                    <div key={field.id}>
                      ...
                      <input
                        ...
                        placeholder="Ara..."
                        className="w-full rounded-lg pl-3 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors bg-white border border-slate-200 text-slate-800 placeholder-slate-400"
                      />
                    </div>
                  ))}
              </div>
              ...
              {hasActiveFilters && (
                <div className="mt-3 pt-3 border-t flex items-center gap-2 flex-wrap border-slate-200">
                  <span className="text-xs font-medium text-slate-500">Aktif:</span>
                  {filters.searchQuery && (
                    <span className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs bg-white text-slate-700 shadow-sm">
                      "{filters.searchQuery}"
                  ...
                  {schema?.fields
                    ...
                    .map((f) => (
                      <span
                        key={f.id}
                        className="inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs bg-white text-slate-700 shadow-sm"
                      >
          ...
          <div className="text-center py-12">
            ...
            {!(hasActiveFilters || hasActiveSearch) && (
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-brand hover:bg-brand-light text-white font-semibold rounded-xl transition-colors"
              >
      ...
      <button
        onClick={() => setShowAddModal(true)}
        disabled={uploading}
        className="fixed bottom-6 right-6 w-16 h-16 bg-brand hover:bg-brand-light text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-200 hover:scale-105 active:scale-95 disabled:opacity-50 z-30"
